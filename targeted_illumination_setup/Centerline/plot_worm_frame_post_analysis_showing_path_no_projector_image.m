function [] = plot_worm_frame_post_analysis_showing_path_no_projector_image(I, center_lines, centerline_color, centerline_stimulus,in_track_index,current_ellipse_ratio,smoothed_path_x,smoothed_path_y,stimulus_delivered,path_history,demo_mode)
...
%     clf
    ...
    if nargin > 5
        ...
        I=imadjust(I);
        I = I ./ 1.1;
        imshow(cat(3, I, I, I) , [], 'InitialMagnification', 500, 'Border','tight');
