function [] = plot_worm_frame(I, center_lines, centerline_color, centerline_stimulus, debugimage,in_track_index,current_ellipse_ratio)
...
%     title (sprintf('Frame=%d, E.R.=%.1f',in_track_index,current_ellipse_ratio));
    %score
%     text(10, 10, num2str(in_track_index), 'Color', 'k','FontSize',0.000014);
% %     %eccentricity
%     text(10, 60, num2str(current_ellipse_ratio,'%4.2f'), 'Color', 'k','FontSize',0.0000014);
    hold off;
%     drawnow
end