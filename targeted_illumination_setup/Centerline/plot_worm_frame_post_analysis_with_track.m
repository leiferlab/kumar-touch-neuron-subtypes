function [] = plot_worm_frame_post_analysis_with_track(I, center_lines, centerline_color, centerline_stimulus, debugimage,in_track_index,current_ellipse_ratio,path_of_worm)
...
imshow(cat(3, I, I, I) + debugimage, [], 'InitialMagnification', 500);
...
% %         end
    ...
    plot(path_of_worm(1:in_track_index,1), path_of_worm(1:in_track_index,2), 'Color', [1 1 0]);
